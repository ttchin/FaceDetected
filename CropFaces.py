        ...
        if pic_file.endswith(jpg_file_ext):
            ...
            if len(faces) > 0:
                ...
                for (x,y,w,h) in faces:
                    ...
                    face_file_name_with_ext = pic_file.replace(jpg_file_ext, '') + ("-face%d" % face_index) + jpg_file_ext
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Crop faces from pictures under the specified directory.')
    parser.add_argument('-d', type=str, required=True, help='the directory of pictures to do face cropping')
